				...
				<View style={styles.segmentedWrapper}>
					...
					>
						<Icon
							...
							size={30}
							color={selectedIndex === 0 ? colors.buttons.activeIcon : colors.buttons.inactiveIcon}
						/>
					</TouchableOpacity>
					<TouchableOpacity
						style={[
					...
					>
						<Icon
							...
							size={30}
							color={selectedIndex === 1 ? colors.buttons.activeIcon : colors.buttons.inactiveIcon}
						/>
					</TouchableOpacity>
					<TouchableOpacity
					...
					>
						<Icon
							...
							size={30}
							color={selectedIndex === 2 ? colors.buttons.activeIcon : colors.buttons.inactiveIcon}
						/>
					</TouchableOpacity>
				</View>
			</View>
