...
export default function DashboardScreen() {
	...
	const ReminderCard = ({ id, title, description, due_date, contacts, reminder_type }) => (
		<TouchableOpacity
			style={styles.card}
			onPress={() => {
				Alert.alert(title, `${description}\n\nContact: ${contacts?.name || 'No contact'}`, [
		...
		>
			...
			{contacts?.name && <Text style={styles.cardContact}>Contact: {contacts.name}</Text>}
			{reminder_type && (
